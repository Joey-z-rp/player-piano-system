...
static pwm_channel_config_t pwm_channels[PWM_CHANNELS] = {
    ...
    {&htim1, TIM_CHANNEL_1, GPIOA, GPIO_PIN_8, 0, 0},  // Channel 0
    {&htim1, TIM_CHANNEL_2, GPIOA, GPIO_PIN_9, 0, 0},  // Channel 1
    {&htim1, TIM_CHANNEL_3, GPIOA, GPIO_PIN_10, 0, 0}, // Channel 2
    {&htim1, TIM_CHANNEL_4, GPIOA, GPIO_PIN_11, 0, 0}, // Channel 3

    // Timer 2 channels (4 channels)
    {&htim2, TIM_CHANNEL_1, GPIOA, GPIO_PIN_0, 0, 0}, // Channel 4
    {&htim2, TIM_CHANNEL_2, GPIOA, GPIO_PIN_1, 0, 0}, // Channel 5
    {&htim2, TIM_CHANNEL_3, GPIOA, GPIO_PIN_2, 0, 0}, // Channel 6
    {&htim2, TIM_CHANNEL_4, GPIOA, GPIO_PIN_3, 0, 0}, // Channel 7

    // Timer 3 channels (4 channels)
    {&htim3, TIM_CHANNEL_1, GPIOA, GPIO_PIN_6, 0, 0}, // Channel 8
    {&htim3, TIM_CHANNEL_2, GPIOA, GPIO_PIN_7, 0, 0}, // Channel 9
    {&htim3, TIM_CHANNEL_3, GPIOB, GPIO_PIN_0, 0, 0}, // Channel 10
    {&htim3, TIM_CHANNEL_4, GPIOB, GPIO_PIN_1, 0, 0}  // Channel 11
};

static _Bool pwm_initialized = 0;
